...
property_sold = Random.rand(2) == 1 ? true : false
	...
	Listing.create(address: street, street_number: street_number.to_s, unit_number:show_unit_number ? unit_number.to_s : '', postal_code:'X1X1X', neighbourhood: 'Awesome!', lot_frontage:'15', 
							 lot_depth: '40', sqft:'1500', bedrooms:'3',bathrooms:'4', price:750000, sold:false, maintenance_fee:600, sold: property_sold,
