class ListingsController < ApplicationController
  ...
  def residential
    @listings = Listing.where(active:true,category_id:[1,2], sold:false).order("priority DESC, price DESC")
  ...
  def commercial
    @listings = Listing.where(active:true,category_id:3, sold:false).order("priority DESC, price DESC")
  ...
  private
    ...
    def listing_params
      params.require(:listing).permit({photos_attributes: [:id,:image]}, {feature_sheet_attributes: [:id,:file]}, {floor_plan_attributes: [:id,:file]}, 
